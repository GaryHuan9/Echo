...
namespace EchoRenderer.Mathematics
{
	public class ExtendedRandom : Random
	{
		...
		public Float2 NextFloat2(float max)            => new(NextFloat(max), NextFloat(max));
		...
		public Float3 NextFloat3(float max)            => new(NextFloat(max), NextFloat(max), NextFloat(max));
		public Float3 NextFloat3(float min, float max) => new(NextFloat(min, max), NextFloat(min, max), NextFloat(min, max));
