...
namespace EchoRenderer.Mathematics.Intersections
{
	...
	public readonly struct TraceRay
	{
		public TraceRay(in Float3 origin, in Float3 direction)
		{
		...
		[FieldOffset(12)] readonly int padding0;
		[FieldOffset(28)] readonly int padding1;
