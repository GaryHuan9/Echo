...
namespace EchoRenderer.Mathematics.Intersections
{
	...
	public abstract class Aggregator
	{
		...
		/// </summary>
		protected static void Validate(ReadOnlyMemory<AxisAlignedBoundingBox> aabbs, ReadOnlySpan<Token> tokens, Func<int, bool> lengthValidator = null)
		{
...
#if DEBUG
			foreach (ref readonly Token token in tokens) Assert.IsTrue(token.IsGeometry);
