...
partial struct Float3
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static explicit operator Int3(in Float3 value) => new((int)value.X, (int)value.Y, (int)value.Z);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static explicit operator Float4(in Float3 value) => new(value.X, value.Y, value.Z, 0f);
}
...
partial struct Float4
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static explicit operator Int4(in Float4 value) => new((int)value.X, (int)value.Y, (int)value.Z, (int)value.W);
...
partial struct Int3
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static explicit operator Int4(in Int3 value) => new(value.X, value.Y, value.Z, 0);

	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static explicit operator Float2(in Int3 value) => (Float2)(Float3)value;
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static implicit operator Float3(in Int3 value) => new(value.X, value.Y, value.Z);
...
partial struct Int4
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static implicit operator Float4(in Int4 value) => new(value.X, value.Y, value.Z, value.W);
}