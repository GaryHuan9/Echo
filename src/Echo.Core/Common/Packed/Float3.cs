...
#region Instance
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Float3 Cross(Float3 other) => new
	(
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public float Angle(Float3 other)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public float SignedAngle(Float3 other, Float3 normal)
	{
		float angle = Angle(other);
		return Cross(other).Dot(normal) < 0f ? -angle : angle;
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)] public float Distance(Float3 other) => (other - this).Magnitude;
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public double DistanceDouble(Float3 other) => (other - this).MagnitudeDouble;

	[MethodImpl(MethodImplOptions.AggressiveInlining)] public float SquaredDistance(Float3 other) => (other - this).SquaredMagnitude;
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public double SquaredDistanceDouble(Float3 other) => (other - this).SquaredMagnitudeDouble;

	[MethodImpl(MethodImplOptions.AggressiveInlining)] public Float3 Min(Float3 other) => new(Math.Min(X, other.X), Math.Min(Y, other.Y), Math.Min(Z, other.Z));
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public Float3 Max(Float3 other) => new(Math.Max(X, other.X), Math.Max(Y, other.Y), Math.Max(Z, other.Z));
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public Float3 Lerp(Float3 other, Float3 value) => new(Scalars.Lerp(X, other.X, value.X), Scalars.Lerp(Y, other.Y, value.Y), Scalars.Lerp(Z, other.Z, value.Z));
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public Float3 Lerp(Float3 other, float value) => new(Scalars.Lerp(X, other.X, value), Scalars.Lerp(Y, other.Y, value), Scalars.Lerp(Z, other.Z, value));

	[MethodImpl(MethodImplOptions.AggressiveInlining)] public Float3 InverseLerp(Float3 other, Float3 value) => new(Scalars.InverseLerp(X, other.X, value.X), Scalars.InverseLerp(Y, other.Y, value.Y), Scalars.InverseLerp(Z, other.Z, value.Z));
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public Float3 InverseLerp(Float3 other, float value) => new(Scalars.InverseLerp(X, other.X, value), Scalars.InverseLerp(Y, other.Y, value), Scalars.InverseLerp(Z, other.Z, value));

	[MethodImpl(MethodImplOptions.AggressiveInlining)] public Float3 Repeat(Float3 length) => new(X.Repeat(length.X), Y.Repeat(length.Y), Z.Repeat(length.Z));
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public Float3 RotateXY(float degrees, Float3 pivot) => CreateXY(XY.Rotate(degrees, pivot.XY), Z);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public Float3 RotateXZ(float degrees, Float3 pivot) => CreateXZ(XZ.Rotate(degrees, pivot.XZ), Y);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public Float3 RotateYZ(float degrees, Float3 pivot) => CreateYZ(YZ.Rotate(degrees, pivot.YZ), X);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public Float3 Damp(Float3 target, ref Float3 velocity, float smoothTime, float deltaTime) => Damp(target, ref velocity, (Float3)smoothTime, deltaTime);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public bool Equals(Float3 other) => X.AlmostEquals(other.X) && Y.AlmostEquals(other.Y) && Z.AlmostEquals(other.Z);
...
#region Static
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static float Dot(Float3 value, Float3 other) => value.Dot(other);
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static double DotDouble(Float3 value, Float3 other) => value.DotDouble(other);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static float Distance(Float3 value, Float3 other) => value.Distance(other);
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static double DistanceDouble(Float3 value, Float3 other) => value.DistanceDouble(other);

	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static float SquaredDistance(Float3 value, Float3 other) => value.SquaredDistance(other);
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static double SquaredDistanceDouble(Float3 value, Float3 other) => value.SquaredDistanceDouble(other);

	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 Min(Float3 value, Float3 other) => value.Min(other);
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 Max(Float3 value, Float3 other) => value.Max(other);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 Clamp(Float3 value, float min = 0f, float max = 1f) => value.Clamp(min, max);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 RotateXY(Float3 value, float degrees) => value.RotateXY(degrees);
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 RotateXY(Float3 value, float degrees, Float2 pivot) => value.RotateXY(degrees, pivot);
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 RotateXY(Float3 value, float degrees, Float3 pivot) => value.RotateXY(degrees, pivot);

	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 RotateXZ(Float3 value, float degrees) => value.RotateXZ(degrees);
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 RotateXZ(Float3 value, float degrees, Float2 pivot) => value.RotateXZ(degrees, pivot);
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 RotateXZ(Float3 value, float degrees, Float3 pivot) => value.RotateXZ(degrees, pivot);

	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 RotateYZ(Float3 value, float degrees) => value.RotateYZ(degrees);
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 RotateYZ(Float3 value, float degrees, Float2 pivot) => value.RotateYZ(degrees, pivot);
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 RotateYZ(Float3 value, float degrees, Float3 pivot) => value.RotateYZ(degrees, pivot);
...
#region Operators
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 operator +(Float3 first, Float3 second) => new(first.X + second.X, first.Y + second.Y, first.Z + second.Z);
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 operator -(Float3 first, Float3 second) => new(first.X - second.X, first.Y - second.Y, first.Z - second.Z);

	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 operator *(Float3 first, Float3 second) => new(first.X * second.X, first.Y * second.Y, first.Z * second.Z);
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 operator /(Float3 first, Float3 second) => new(first.X / second.X, first.Y / second.Y, first.Z / second.Z);

	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 operator *(Float3 first, float second) => new(first.X * second, first.Y * second, first.Z * second);
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 operator /(Float3 first, float second) => new(first.X / second, first.Y / second, first.Z / second);

	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 operator *(float first, Float3 second) => new(first * second.X, first * second.Y, first * second.Z);
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 operator /(float first, Float3 second) => new(first / second.X, first / second.Y, first / second.Z);

	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 operator +(Float3 value) => value;
	[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 operator -(Float3 value) => new(-value.X, -value.Y, -value.Z);
